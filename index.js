...
const foodSound = new Audio('./image/foodEaten.wav');
const gameOverSound = new Audio('./image/gameOver.wav');
const moveSound = new Audio('./image/moveSnake.wav');
...
function gameEngine() {
    ...
    if (snakeArr[0].y === food.y && snakeArr[0].x === food.x) {
        ...
        if (score > highScoreVal) {
            ...
            highScoreBar.innerHTML = 'High Score : ' + highScoreVal;
        }
...
let highScoreVal;
const highScoreBar = document.querySelector('.highScore');
